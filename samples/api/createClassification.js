...
/** 
 * Generate a classification on an existing document. The provided collection
 * and task must already exist and a model must already be trained. All arguments 
 * are passed in at the command line, and all are required for this sample 
 * application.
 ...
 * param argument[3] {String} Document name, the document that will be classified
 */
