...
/** 
 * Deletes an existing collection. The relevant collection must exist and must
 * be empty of all documents. All arguments are passed in at the command line, and 
 * all are required for this sample application. 
 * param argument[0] {String} API key
 * param argument[1] {String} Collection to be deleted, the collection must exist
 */
...
client.deleteCollection(collectionName, function (err, resp) {
  if (!err && resp) {
