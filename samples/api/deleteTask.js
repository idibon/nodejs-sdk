...
/** 
 * Deletes an existing task. The relevant collection and task must exist.
 ...
 * param argument[1] {String} Collection that contains the task
 * param argument[2] {String} Task name
 */
...
if (process.argv.length !== 5) {
  throw new Error("Incorrect number of arguments provided. Usage is: " +
    "node deleteTask.js $API_KEY $COLLECTION $TASK");
}
...
client.deleteTask(collectionName, taskName, function (err, resp) {
  if (!err && resp) {
